                ...
                <div className="lg:w-2/3 xl:w-1/2 w-full px-12 xs:px-16 md:px-52 lg:px-56 xl:px-32 pb-14">
                    <div className="flex flex-row gap-x-1 justify-center items-center pb-8">
                        <span className="text-lg xl:text-xl xlx:text-[24px] font-semibold text-white">
                            EVENT <span className="bg-gradient-to-br from-green-400 to-green-700 bg-clip-text text-transparent">MANAGER</span>
                        </span>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        {/* Name Field */}
                        <div className="mb-4">
                            <label className="block text-sm font-semibold text-white mb-2" htmlFor="name">Name</label>
                            <input
                                type="text"
                                id="name"
                                name="name"
                        ...
                        {/* Phone Field */}
                        <div className="mb-4">
                            <label className="block text-sm font-semibold text-white mb-2" htmlFor="phone">Phone</label>
                            <input
                                type="text"
                                id="phone"
                                name="phone"
                        ...
                        <div className="mb-4 relative">
                            <label className="block text-sm text-white mb-2 font-medium" htmlFor="password">Password</label>
                            <input
                        ...
                        <div className="mb-4 relative">
                            <label className="block text-sm text-white mb-2 font-medium" htmlFor="confirmPassword">Confirm Password</label>
                            <input
                                type={showPassword ? "text" : "password"}
                                id="confirmPassword"
                    ...
                    <div className="text-center mt-4">
                        <p className="text-sm text-gray-400">
                            Already have an account? <Link to="/" className="text-green-400 font-medium hover:underline">Login</Link>
                        </p>
                    </div>
                </div>
            </div>
